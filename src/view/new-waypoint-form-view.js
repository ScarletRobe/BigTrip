 ...
 */
const getNewPointFormTemplate = (offers, destinations) => (
        ...
        <div class="event__type-wrapper">
          ...
          <div class="event__type-list">
            <fieldset class="event__type-group">
              ...
              ${getEventTypeItems('flight', offers)}
      ...
      <section class="event__details">
        <section class="event__section  event__section--offers">
          ...
          <div class="event__available-offers">
            ...
            ${getEventAvailableOffers('flight', [], offers)}
...
export default class NewWaypointFormView extends AbstractView {
  ...
  get template () {
    return getNewPointFormTemplate(this.offers, this.destinations);
  }
}
