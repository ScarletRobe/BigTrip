...
export default class NewWaypointFormView extends AbstractStatefulView {
      ...
      case this.#Pickers.DATE_FROM:
        ...
        this.#dateFromPicker = flatpickr(
          this.element.querySelector('#event-start-time-1'),
          {
            ...
            maxDate: humanizeDate(this._state.dateTo, 'DD/MM/YY HH:mm'),
      ...
      case this.#Pickers.DATE_TO:
        ...
        this.#dateToPicker = flatpickr(
          this.element.querySelector('#event-end-time-1'),
          {
            ...
            minDate: humanizeDate(this._state.dateFrom, 'DD/MM/YY HH:mm'),
  ...
  #eventDateChangeHandler = ([date], field) => {
    ...
    this.#validation.date.valid = !(this._state.dateTo.diff(this._state.dateFrom, 'm') < 0);
